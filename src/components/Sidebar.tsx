  ...
  return (
    ...
    >
      ...
      <div className="p-6 pb-4 flex items-center justify-between border-b border-white/5">
        ...
        >
          <div className="w-14 h-14 rounded-xl bg-zinc-900 border border-white/10 flex items-center justify-center group-hover:border-white/20 transition overflow-hidden shadow-sm">
