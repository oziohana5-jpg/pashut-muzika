...
apiRouter.get('/music/artist/:id', async (req: AuthenticatedRequest, res) => {
  ...
  if (!data) {
    ...
    const fallbackArtist = {
      ...
      imageUrl: String(req.query.imageUrl || '') || 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&auto=format&fit=crop&q=80',
      bannerUrl: String(req.query.imageUrl || '') || 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=1200&auto=format&fit=crop&q=80',
      monthlyListeners: 0,
